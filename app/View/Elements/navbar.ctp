<nav class="navbar corPadrao sticky-top">
  <div class="container-fluid d-flex align-items-center justify-content-between">
    ...
    <div class="navbar-logo-text d-flex align-items-center">
      <h5 class="navbar-title">Estácio Odontologia</h5>
    </div>
    ...
    <div class="offcanvas corPadrao offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          <li class="nav-item">
            <a id="navProntuario" class="nav-link" href="#">Prontuários<img src="./img/prontuario.png"></a>
          </li>
          <li class="nav-item">
            <a id="navNovo" class="nav-link" href="#">Novo Prontuário<img src="./img/novoprontuario.png"></a>
          </li>
          <li class="nav-item">
