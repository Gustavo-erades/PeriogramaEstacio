...
<div class="form-group mt-2 mb-5">
    ...
    <div class="caixa_perguntas">
        ...
        <div class="mb-3">
            <label for="implante" class="mb-2_text-dark">Já realizou implantes dentários? Se <b>SIM</b> como foi sua experiência?</label>
            <textarea name="implante" class="editorOdonto" id="implante"></textarea>
        </div>
        <div class="mb-3">
            <label for="tratOdonto" class="mb-2_text-dark">Quanto tempo tem seu último tratamento odontológico?</label>
            <textarea name="tratOdonto" class="editorOdonto" id="tratOdonto"></textarea>
        </div>
        <div class="mb-3">
            <label for="sorriso" class="mb-2_text-dark">O que o/a incomoda em seu sorriso?</label>
